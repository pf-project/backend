...
public class CompteGeneralController {
    ...
    public ResponseEntity<?> create(@RequestBody final CompteGeneralDTO dto, final Authentication auth) {
    ...
    public ResponseEntity<?> update(@PathVariable final String id, @RequestBody final CompteGeneralDTO dto, final Authentication auth) {
