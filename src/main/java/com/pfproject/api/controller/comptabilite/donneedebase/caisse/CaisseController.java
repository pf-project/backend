...
public class CaisseController {
    ...
    public ResponseEntity<?> create(@RequestBody final CaisseDTO dto, final Authentication auth) {
    ...
    public ResponseEntity<?> update(@PathVariable final String id, @RequestBody final CaisseDTO dto, final Authentication auth) {
